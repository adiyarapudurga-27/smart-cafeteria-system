...
const getTimeSlot = () => {
  ...
  const getAISuggestion = (item: MenuItem) => {
    const foodMap: Record<string, string[]> = {
      Burger: ['French Fries', 'Soft Drink', 'Cold Coffee'],
      'Pizza Slice': ['Soft Drink', 'Cold Coffee'],
      'Chicken Biryani': ['Curd Rice', 'Gulab Jamun', 'Rasgulla'],
      Idli: ['Tea', 'Coffee'],
      Dosa: ['Tea', 'Coffee'],
      Samosa: ['Tea', 'Coffee'],
      Sandwich: ['Coffee', 'Mango Juice'],
      Coffee: ['Sandwich', 'Cupcake'],
      Tea: ['Samosa', 'Veg Puff'],
      'French Fries': ['Burger', 'Soft Drink'],
      'Ice Cream': ['Brownie', 'Chocolate Cake'],
      'Mango Juice': ['Sandwich', 'Spring Roll'],
      Poori: ['Tea', 'Coffee'],
      'Veg Meals': ['Buttermilk', 'Curd Rice'],
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="sticky top-0 z-50 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          {aiMessage && (
            <div className="mt-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white p-4 rounded-2xl shadow-lg animate-in slide-in-from-top duration-300">
              <div className="flex items-center gap-2">
                <Sparkles className="w-5 h-5" />
                <p className="font-bold">AI Suggestion</p>
              </div>
              <p className="text-sm mt-1">{aiMessage}</p>
            </div>
          )}
        </div>
